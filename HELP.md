...
* [Spring for Apache ActiveMQ 5](https://docs.spring.io/spring-boot/docs/2.3.7.RELEASE/reference/htmlsingle/#boot-features-activemq)
...
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/2.3.7.RELEASE/reference/htmlsingle/#howto-execute-flyway-database-migrations-on-startup)
